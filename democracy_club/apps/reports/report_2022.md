...
We strengthened our partnership with the Electoral Commission, launching and running their API and interactive widget, using our data. The Electoral Commission’s API is now used by GOV.UK to run its [“Contact your local Electoral Registration Office”](https://www.gov.uk/contact-electoral-registration-office) service. We also received funding and resources from the Welsh Government to improve our polling station finder and candidate look-up services, including translating [WhoCanIVoteFor.co.uk](https://whocanivotefor.co.uk/) into Welsh.
...
<div class="ds-table">
<table>
<caption>Example previous party affiliation</caption>
<tr>
...
### Advanced voting
5 May saw four ‘[advanced voting](https://gov.wales/written-statement-update-flexible-voting-pilots)’ trials. Voters in four council areas — Blaenau Gwent, Bridgend, Caerphilly and Torfaen — were able to cast a ballot in the days before the poll.
